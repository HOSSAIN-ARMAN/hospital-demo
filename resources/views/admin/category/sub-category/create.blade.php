...
@section('content')
    @include('admin.components.page_header', [
       ...
       'route' => route('admin.category.sub-category.index')
    ])
    ...
    <div class="col-sm-9">
        <form role="form"
              ...
              action="{{route('admin.category.sub-category.store')}}"
        >

        @csrf
        <!--category-->
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="name">category <sup class="red">*</sup></label>
                <div class="col-sm-4">
        ...
        <!-- Name -->
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                    ...
                    <a href="{{route('admin.category.sub-category.index')}}" class="btn btn-sm btn-gray">
